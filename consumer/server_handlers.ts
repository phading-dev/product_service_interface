...
import { RECORD_PLAY_HISTORY, RecordPlayHistoryRequestBody, RecordPlayHistoryResponse, SAVE_PRODUCT, SaveProductRequestBody, SaveProductResponse, CREATE_SAVED_PRODUCT_LIST, CreateSavedProductListRequestBody, CreateSavedProductListResponse, DELETE_SAVED_PRODUCT_LIST, DeleteSavedProductListRequestBody, DeleteSavedProductListResponse, LIST_SAVED_PRODUCT_LISTS, ListSavedProductListsRequestBody, ListSavedProductListsResponse, GET_SAVED_PRODUCT_LIST, GetSavedProductListRequestBody, GetSavedProductListResponse, EDIT_SAVED_PRODUCT_LIST, EditSavedProductListRequestBody, EditSavedProductListResponse, GET_SHOW, GetShowRequestBody, GetShowResponse, GET_SHOW_SNAPSHOT, GetShowSnapshotRequestBody, GetShowSnapshotResponse } from './interface';
...
export abstract class GetSavedProductListHandlerInterface implements ServiceHandlerInterface {
  public descriptor = GET_SAVED_PRODUCT_LIST;
  public abstract handle(
    requestId: string,
